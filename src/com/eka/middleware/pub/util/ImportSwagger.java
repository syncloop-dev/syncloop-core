...
import com.eka.middleware.pub.util.postman.UrlQuery;
...
import static com.eka.middleware.pub.util.ImportSwagger.createInvokeStep;
import static com.eka.middleware.pub.util.ImportSwagger.createPreInvokeMapping;
...
public class ImportSwagger {
    ...
    public static Map<String, String> asServerStub(String folderPath, byte[] openAPI, DataPipeline dataPipeline, boolean isClientRequested, String packageName) throws Exception {
        ...
        for (Entry<String, PathItem> entry : pathItemMap) {
           ...
           /* System.out.println("alias >> " + alias);
            ...
            flow = generateServerStub(op, swagger, servicePath, isClientRequested, packageName,alias);
            if (flow != null) {
            ...
            flow = generateServerStub(op, swagger, servicePath1, isClientRequested, packageName, alias);
            if (flow != null) {
                String json = Json.pretty().writeValueAsString(flow);
            ...
            flow = generateServerStub(op, swagger, servicePath2, isClientRequested, packageName, alias);
            if (flow != null) {
                String json = Json.pretty().writeValueAsString(flow);
            ...
            flow = generateServerStub(op, swagger, servicePath3, isClientRequested, packageName, alias);
            if (flow != null) {
                String json = Json.pretty().writeValueAsString(flow);
            ...
            flow = generateServerStub(op, swagger, servicePath4, isClientRequested, packageName, alias);
            if (flow != null) {
                String json = Json.pretty().writeValueAsString(flow);
    ...
    private static Map<String, Object> generateServerStub(Operation op, OpenAPI swagger, String servicePath, boolean isClientRequested, String packageName,String alias) throws FileNotFoundException {
        if (op == null)
            return null;
          ...
          //  createPreInvokeMapping(invokeClient, "copy", "string", "/apiKey", "document/string", "/requestHeaders/apiKey");
            ...
            for (String securitySchemesList : securitySchemes.keySet()) {
                ...
                if (SecurityScheme.Type.APIKEY.equals(type)) {
                    ...
                    if (SecurityScheme.In.HEADER.equals(securityScheme.getIn())) {
                        createVariables(intiMapStep, "requestHeaders/" + securityScheme.getName(), "${apiKey}", Evaluate.EEV, "document/string");
                        createPreInvokeMapping(invokeClient, "copy", "document/string", "/requestHeaders/"+securityScheme.getName(), "string", "/apiKey");
                        //createPreInvokeMapping(invokeClient, "copy", "string", "/apiKey", "document/string", "/requestHeaders/"+securityScheme.getName());
    ...
    public static Map<String, Object> createInvokeStep(List<Object> parent, String serviceType, String
            serviceFqn, String comment) {
     ...
     * @return
     */
    public static Map<String, Object> createSwitch(List<Object> parent, String serviceType, String
            serviceFqn, String comment) {
     ...
     * @param typePath
     */
    public static void createVariables(Map<String, Object> mapStep, String path, String value, Evaluate
            evaluate, String typePath) {
    ...
    public static void createMapping(Map<String, Object> mapStep, String op, String inTypePath, String
            from, String outTypePath,
                                     String to) {
    ...
    public static void createPreInvokeMapping(Map<String, Object> mapStep, String op, String inTypePath, String
            from, String outTypePath,
                                              String to) {
        List<Object> transformers = (List<Object>) mapStep.get("transformers");
        List<Object> lines = (List<Object>) mapStep.get("lines");
    ...
    public static void createPostInvokeMapping(Map<String, Object> mapStep, String op, String inTypePath, String
            from, String outTypePath,
                                               String to) {
        List<Object> transformers = (List<Object>) mapStep.get("transformers");
        List<Object> lines = (List<Object>) mapStep.get("lines");
